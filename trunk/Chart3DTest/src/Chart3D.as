package
{
	...
	public class Chart3D extends Sprite
	{
		...
		public function setup3D(w:Number,h:Number):void
		{
			var sp:Sprite = new Sprite();
			
			sp.graphics.beginFill(0x868686);
		...
		public function createAxisFromXML(axis:XML):void
		{
			...
			var pZ:Plane = this.createPlane(200,100,zTitle,new TextFormat(null,"58"));
			...
			var pX:Plane = this.createPlane(200,100,xTitle,new TextFormat(null,"58"));
			pX.x = xMax/2;
			pX.y = 0;
			...
			var pY:Plane = this.createPlane(200,100,yTitle,new TextFormat(null,"58"));
