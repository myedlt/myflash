package info.osmatrix.rmframework.app.view
{
	...
	public class FlashViewHelper implements IMainView
	{
		private var viewComponent:Object;

		public function FlashViewHelper(app:Object):void
		{
			...
			viewComponent.sec0103_btn.addEventListener(MouseEvent.CLICK, onSectionChanged);			
			viewComponent.sec0104_btn.addEventListener(MouseEvent.CLICK, onSectionChanged);			
			...
			viewComponent.sec0203_btn.addEventListener(MouseEvent.CLICK, onSectionChanged);			
			viewComponent.sec0301_btn.addEventListener(MouseEvent.CLICK, onSectionChanged);			
		...
		public function updateLocator(chapter:ChapterVO, section:SectionVO):void
		{
			...
			viewComponent.locator_txt.text = "".concat(chapter.name, "->", section.name);
			viewComponent.page_txt.text = "".concat("当前页 ",1,", 总页数 ",8);
